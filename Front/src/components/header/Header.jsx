            ...
            <AppBar position="fixed" sx={{ background: "black" }}>
                <Container maxWidth="xl">
                    <Toolbar disableGutters>
                            ...
                            >
                                ...
                                {!isLogin &&
                                    <div className="links-menu">
                                        <Button color="inherit" sx={{ marginLeft: 0 }} onClick={handleCloseNavMenu}>
                                            <Link to={"/SignUp"} className="nav-link2">הרשמה</Link>
                                        </Button>
                                        <Button color="inherit" onClick={handleCloseNavMenu}>
                        ...
                        <Box
                            sx={{ flexGrow: { md: 0, xs: 1 }, ml: { xs: -3, md: 0 }, }}
                        >
                            {isLogin ? (
                                <>
                                    <Link to={"/favorites"}>
                                    ...
                                    <IconButton
                                        ...
                                        sx={{ marginRight: { sm: 1.5, xs: 0 }, '& .MuiSvgIcon-root': { fontSize: 32 } }}
                                    >
